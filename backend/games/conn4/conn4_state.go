...
import (
	...
	conn4_core "github.com/arian-nj/chigame/backend/games/conn4/core"
...
func (g *Conn4State) AddPlayer(id int, name string, socket *socket.Socket) {
	player := NewConn4Player(id, name, socket)
