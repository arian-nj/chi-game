...
const (
	...
	FinderErrorType_FINDER_ERROR_TYPE_HAS_ROOM     FinderErrorType = 3
...
const file_finder_v1_finder_proto_rawDesc = "" +
	...
	"\x11FINDER_TYPE_ERROR\x10\x05*\xb6\x01\n" +
	"\x0fFinderErrorType\x12!\n" +
	"\x1dFINDER_ERROR_TYPE_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16FINDER_ERROR_TYPE_AUTH\x10\x01\x12 \n" +
	"\x1cFINDER_ERROR_TYPE_HAS_TICKET\x10\x02\x12\x1e\n" +
	"\x1aFINDER_ERROR_TYPE_HAS_ROOM\x10\x03\x12\"\n" +
	"\x1eFINDER_ERROR_TYPE_INVALID_GAME\x10\x04B\x9d\x01\n" +
	"\rcom.finder.v1B\vFinderProtoP\x01Z:github.com/arian-nj/chigame/backend/gen/finder/v1;finderv1\xa2\x02\x03FXX\xaa\x02\tFinder.V1\xca\x02\tFinder\\V1\xe2\x02\x15Finder\\V1\\GPBMetadata\xea\x02\n" +
