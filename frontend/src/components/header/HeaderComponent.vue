...
.site-hero:hover {
    ...
    box-shadow:
        1px 1px 0 #000,
        0 12px 40px rgba(0, 40, 120, 0.4),
        0 4px 12px rgba(0, 0, 0, 0.25);
}

.site-hero:hover .site-hero-titlebar {
...
.chrome-btn-close::before,
.chrome-btn-close::after {
    content: '';
    position: absolute;
    left: 50%;
    top: 50%;
...
.site-hero-body {
    ...
    background:
        linear-gradient(
            ...
            rgba(210, 228, 248, 0.14) 50%,
            rgba(180, 210, 240, 0.1) 100%
        );
