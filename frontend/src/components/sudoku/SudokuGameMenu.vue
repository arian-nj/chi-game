...
function onSetDifficulty(level: Difficulty) {
    emit('set-difficulty', level);
    closeGameMenu();
}
        ...
        <div ref="menuRootRef" class="xp-menu-root">
            ...
            <div v-if="gameMenuOpen" class="xp-dropdown" @click.stop>
                ...
                <button
                    ...
                    @click="onSetDifficulty('easy')"
                >
                    <span class="xp-dropdown-bullet">{{ difficulty === 'easy' ? '•' : '' }}</span>
                    Easy
                </button>
                <button
                    type="button"
                    class="xp-dropdown-item"
                    @click="onSetDifficulty('medium')"
                >
                    <span class="xp-dropdown-bullet">{{ difficulty === 'medium' ? '•' : '' }}</span>
                    Medium
                </button>
                <button
                    type="button"
                    class="xp-dropdown-item"
                    @click="onSetDifficulty('hard')"
                >
                    <span class="xp-dropdown-bullet">{{ difficulty === 'hard' ? '•' : '' }}</span>
                    Hard
                </button>
            </div>
        </div>
        <a href="#how-to-play-sudoku" class="xp-menu-item">Help</a>
    </div>
</template>
