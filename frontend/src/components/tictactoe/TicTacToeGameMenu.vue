...
function onSetBoardSize(size: BoardSizeKey) {
    emit('set-board-size', size);
    closeGameMenu();
}
    ...
    <div class="xp-menubar">
        <div ref="menuRootRef" class="xp-menu-root">
            ...
            <div v-if="gameMenuOpen" class="xp-dropdown" @click.stop>
                ...
                <div class="xp-dropdown-separator" />
                <button type="button" class="xp-dropdown-item" @click="onSetBoardSize('classic')">
                    <span class="xp-dropdown-bullet">{{ boardSizeKey === 'classic' ? '•' : '' }}</span>
                    Classic (3×3)
                </button>
                <button type="button" class="xp-dropdown-item" @click="onSetBoardSize('expert')">
                    <span class="xp-dropdown-bullet">{{ boardSizeKey === 'expert' ? '•' : '' }}</span>
                    Expert (5×5)
                </button>
        ...
        <a href="#how-to-play-tictactoe" class="xp-menu-item">Help</a>
    </div>
</template>
