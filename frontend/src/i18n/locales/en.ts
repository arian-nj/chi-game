export default {
  ...
  about: {
    ...
    sections: {
      ...
      games: {
        title: 'Games today',
        body: 'chi game focuses on single-device play: challenge the bot or pass the device with a friend. Tic Tac Toe and Connect 4 are available now, with more classics on the way.',
      },
      roadmap: {
        title: 'What is next',
        body: 'Later we will add online multiplayer so you can play with friends remotely. Until then, enjoy quick offline matches and check the changelog for updates.',
      },
    },
  },
  changelog: {
  ...
  invite: {
    roomTitle: 'Game room',
    roomIntro: 'Create a room and share the invite link, or enter a code to join someone else.',
    joining: 'Joining room…',
    codeLabel: 'Invite code',
    linkLabel: 'Invite link (tap to copy)',
    copy: 'Copy',
    playersLabel: 'Players',
    waitingForGuest: 'Waiting for someone to join…',
    playTitle: 'Choose a game',
    playHint: 'Pick a game to play together on this device.',
    chooseGame: 'Games',
    backToLobby: 'Back to invite lobby',
    ...
    alreadyInRoom: 'You are already in another room',
    needAuth: 'Sign in as guest to play online (reload if needed)',
