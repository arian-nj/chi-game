...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/arian-nj/chigame/backend/gen/auth/v1"
	http "net/http"
	strings "strings"
)
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	return &authServiceClient{
		validateGuest: connect.NewClient[v1.ValidateGuestRequest, v1.ValidateGuestResponse](
			...
			connect.WithSchema(authServiceMethods.ByName("ValidateGuest")),
...
func (c *authServiceClient) ValidateGuest(ctx context.Context, req *connect.Request[v1.ValidateGuestRequest]) (*connect.Response[v1.ValidateGuestResponse], error) {
	return c.validateGuest.CallUnary(ctx, req)
}
